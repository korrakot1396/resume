        ...
        <Fade bottom duration={1000} distance="40px">
          <div className="address-heading-div">
            ...
            <div className="address-heading-text-div">
              ...
              <h1 className="address-heading-text">{positionSection['title']}</h1>
              <p className="contact-header-detail-text subTitle">
                {positionSection['subtitle']}
              </p>
              <h1 className="address-heading-text">{addressSection['title']}</h1>
              <p className="contact-header-detail-text subTitle">
                {addressSection['subtitle']}
              </p>
              <h1 className="address-heading-text">{phoneSection['title']}</h1>
              <p className="contact-header-detail-text subTitle">
