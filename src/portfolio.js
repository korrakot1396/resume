...
const socialMediaLinks = {
  ...
  stackoverflow: "https://stackoverflow.com/users/13227364/korrakot-triwichian",
};
...
const certifications = {
...

    {
      ...
      logo_path: "chula_mooc.png",
			certificate_link:
				"https://drive.google.com/open?id=1qywnaedxNi7_Odv3wdoecYTalaiSnTYu",
			alt_name: "Chulalongkorn University - Practical Data Analytics using RapidMiner ",
      color_code: "#d2d2d2",
		},
		{
			title: "Statistics and Computational",
			subtitle: "- MU MOOC, 2020",
			logo_path: "mu_mooc.png",
			certificate_link:
				"https://drive.google.com/file/d/1lNADCsdzjB-OlTlH6bg_VR2EdwQWBIBW/view?usp=sharing",
			alt_name: "Mahidol University - Statistics and Computational Application for Social and Health Research",
			color_code: "#14148C"
		},
		{
			title: "COVID English",
			subtitle: "- Faculty of Humanities, 2020",
			logo_path: "ku_mooc.png",
			certificate_link:
